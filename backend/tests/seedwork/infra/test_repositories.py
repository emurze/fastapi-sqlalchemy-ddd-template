...
class TestMemoryCommandRepository:
    @pytest.mark.unit
    async def test_add_and_get(self, mem_repo: ICommandRepo) -> None:
    ...
    @pytest.mark.unit
    async def test_delete(self, mem_repo: ICommandRepo) -> None:
        example = Example(name="example")
        await mem_repo.add(example)
    ...
    @pytest.mark.unit
    async def test_delete_by_id(self, mem_repo: ICommandRepo) -> None:
        example = Example(name="example")
        await mem_repo.add(example)
...
class TestSqlAlchemyCommandRepository:
    ...
    async def test_add_and_get(self, sql_repo: ICommandRepo) -> None:
        await self.mem_tests.test_add_and_get(sql_repo)

    @pytest.mark.integration
    async def test_delete(self, sql_repo: ICommandRepo) -> None:
        await self.mem_tests.test_delete(sql_repo)

    @pytest.mark.integration
    async def test_delete_by_id(self, sql_repo: ICommandRepo) -> None:
        await self.mem_tests.test_delete_by_id(sql_repo)

    @pytest.mark.integration
    async def test_get_by_id_not_found_as_none(
        self, sql_repo: ICommandRepo
    ) -> None:
